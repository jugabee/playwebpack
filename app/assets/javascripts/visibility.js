  ...
  de_polygonal_ds_DLL.prototype = {
    ...
    sort: function(compare, useInsertionSort) {
      ...
      if (this._size > 1) {
        ...
        if (compare == null)
          if (useInsertionSort) this.head = this._insertionSortComparable(this.head);
    ...
    remove: function(x) {
      ...
      var node = this.head;
      while (node != null)
        if (node.val == x) node = this.unlink(node);
        else node = node.next;
      return this._size < s;
    },
    ...
    iterator: function() {
      if (this.reuseIterator) {
        if (this._iterator == null) {
          if (this._circular) return new de_polygonal_ds_CircularDLLIterator(this);
          else return new de_polygonal_ds_DLLIterator(this);
        } else this._iterator.reset();
        return this._iterator;
      } else if (this._circular) return new de_polygonal_ds_CircularDLLIterator(this);
      else return new de_polygonal_ds_DLLIterator(this);
    },
    toArray: function() {
    ...
    _insertionSortComparable: function(node) {
      ...
      while (n != null) {
        ...
        if ((js_Boot.__cast(p.val, de_polygonal_ds_Comparable)).compare(v) < 0) {
          var i = p;
          while (i.prev != null)
            if ((js_Boot.__cast(i.prev.val, de_polygonal_ds_Comparable)).compare(v) < 0) i = i.prev;
            else break;
          if (m != null) {
            p.next = m;
            m.prev = p;
    ...
    _insertionSort: function(node, cmp) {
      ...
      while (n != null) {
        ...
        if (cmp(v, p.val) < 0) {
          var i = p;
          while (i.prev != null)
            if (cmp(v, i.prev.val) < 0) i = i.prev;
            else break;
          if (m != null) {
            p.next = m;
            m.prev = p;
    ...
    _getNode: function(x) {
      if (this._reservedSize == 0 || this._poolSize == 0) return new de_polygonal_ds_DLLNode(x, this);
      else {
